use crate::options::encrypt::generic::{ask_for_string, ask_for_multiline_armored_string, format_armored_value};
...
pub async fn generate_key_pair() -> SignedSecretKey {
    loop {
        ...
        println!("generating a key pair with email: {} and passphrase: {}", email, passphrase);
